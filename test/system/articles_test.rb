...
class ArticlesTest < ApplicationSystemTestCase
  ...
  test "creating a Article" do
    ...
    fill_in "Employability", with: @article.employability
    fill_in "Recruiting", with: @article.recruiting
    fill_in "Skills", with: @article.skills
    fill_in "Street", with: @article.street
